...
<CardTitle className="text-3xl font-[family-name:var(--font-overlock)] font-bold tracking-tight text-card-foreground">Create account</CardTitle>
...
<Label htmlFor="name" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Full Name</Label>
<Input 
id="name" 
required
value={name}
...
<div className="space-y-2">
<Label htmlFor="password" title="At least 6 characters" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Password</Label>
<Input 
id="password" 
type="password" 
required
...
<span className="bg-card px-3 text-muted-foreground font-medium tracking-widest">Privacy guaranteed</span>
</div>
</div>
<p className="text-[11px] text-center text-muted-foreground leading-relaxed max-w-[280px] mx-auto">
By joining, you agree to our <Link href="/terms" className="hover:text-foreground underline">Terms of Service</Link> and <Link href="/privacy" className="hover:text-foreground underline">Privacy Policy</Link>.
</p>
</div>
</CardContent>
</Card>
