				...
				<div className="flex justify-center lg:justify-end">
					<Card className="w-full max-w-[480px] border-none shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] rounded-[32px] bg-white/90 backdrop-blur-md">
						<CardHeader className="space-y-4 pb-8 text-center lg:text-left">
							...
							<CardTitle className="text-3xl font-[family-name:var(--font-overlock)] font-bold tracking-tight text-gray-900">Sign in</CardTitle>
						...
						<CardContent className="space-y-6">
							<form className="space-y-5" onSubmit={handleLogin}>
								...
								<div className="space-y-2">
									<div className="flex justify-between items-center px-1">
										<Label htmlFor="password" className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Password</Label>
							...
							<div className="space-y-5 pt-2">
								<p className="text-center text-gray-500 text-sm">
									...
									<Link href="/signup" className="text-gray-900 font-bold hover:underline underline-offset-4">
										Create one
									</Link>
								</p>
								<div className="relative">
									...
									<div className="relative flex justify-center text-[10px] uppercase">
										<span className="bg-white px-3 text-gray-400 font-medium tracking-widest">Secure access</span>
									</div>
								</div>
