  ...
  return (
    <div className="min-h-screen bg-[#F1F9F7] flex flex-col">
      ...
      <main className="flex-1 p-4 md:p-8">
        <section className="mx-auto w-full max-w-4xl rounded-3xl bg-white border border-gray-100 p-6 md:p-8 shadow-sm">
          <div className="mb-6">
            <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#7BDFF2]">Notifications</p>
            <h1 className="text-3xl md:text-4xl font-[family-name:var(--font-overlock)] font-bold text-gray-900 mt-2">Sarah&apos;s nudges</h1>
          ...
          <div className="space-y-3">
            {nudges.map((nudge) => (
              <article key={nudge.title} className="rounded-2xl border border-gray-100 p-4 md:p-5 hover:shadow-sm transition-shadow">
                ...
                <p className="mt-3 text-xs text-gray-400">{nudge.time}</p>
              </article>
            ))}
          </div>
